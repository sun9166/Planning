...
#ifndef PROTOBUF_poly_5fst_5fspeed_5fconfig_2eproto__INCLUDED
#define PROTOBUF_poly_5fst_5fspeed_5fconfig_2eproto__INCLUDED
...
class PolyStSpeedConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.PolyStSpeedConfig) */ {
 public:
  PolyStSpeedConfig();
  ...
  inline PolyStSpeedConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  PolyStSpeedConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:acu.planning.PolyStSpeedConfig)
 private:
  ...
  void set_has_min_decel();
  void clear_has_min_decel();
  void set_has_speed_limit_buffer();
  void clear_has_speed_limit_buffer();
  ...
  void set_has_unblocking_obstacle_cost();
  void clear_has_unblocking_obstacle_cost();
  ...
  friend struct ::protobuf_poly_5fst_5fspeed_5fconfig_2eproto::TableStruct;
  friend void ::protobuf_poly_5fst_5fspeed_5fconfig_2eproto::InitDefaultsPolyStSpeedConfigImpl();
};
// ===================================================================
...
inline double PolyStSpeedConfig::total_path_length() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.total_path_length)
...
inline void PolyStSpeedConfig::set_total_path_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.total_path_length)
}
...
inline double PolyStSpeedConfig::total_time() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.total_time)
  return total_time_;
}
inline void PolyStSpeedConfig::set_total_time(double value) {
  set_has_total_time();
  total_time_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.total_time)
}
...
inline double PolyStSpeedConfig::preferred_accel() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.preferred_accel)
...
inline void PolyStSpeedConfig::set_preferred_accel(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.preferred_accel)
}
...
inline double PolyStSpeedConfig::preferred_decel() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.preferred_decel)
...
inline void PolyStSpeedConfig::set_preferred_decel(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.preferred_decel)
}
...
inline double PolyStSpeedConfig::max_accel() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.max_accel)
  return max_accel_;
}
inline void PolyStSpeedConfig::set_max_accel(double value) {
  set_has_max_accel();
  max_accel_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.max_accel)
}
...
inline double PolyStSpeedConfig::min_decel() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.min_decel)
  return min_decel_;
}
inline void PolyStSpeedConfig::set_min_decel(double value) {
  set_has_min_decel();
  min_decel_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.min_decel)
}
...
inline double PolyStSpeedConfig::speed_limit_buffer() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.speed_limit_buffer)
...
inline void PolyStSpeedConfig::set_speed_limit_buffer(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.speed_limit_buffer)
}
...
inline double PolyStSpeedConfig::speed_weight() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.speed_weight)
  return speed_weight_;
}
inline void PolyStSpeedConfig::set_speed_weight(double value) {
  set_has_speed_weight();
  speed_weight_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.speed_weight)
}
...
inline double PolyStSpeedConfig::jerk_weight() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.jerk_weight)
  return jerk_weight_;
}
inline void PolyStSpeedConfig::set_jerk_weight(double value) {
  set_has_jerk_weight();
  jerk_weight_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.jerk_weight)
}
...
inline double PolyStSpeedConfig::obstacle_weight() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.obstacle_weight)
...
inline void PolyStSpeedConfig::set_obstacle_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.obstacle_weight)
}
...
inline double PolyStSpeedConfig::unblocking_obstacle_cost() const {
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.unblocking_obstacle_cost)
...
inline void PolyStSpeedConfig::set_unblocking_obstacle_cost(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.PolyStSpeedConfig.unblocking_obstacle_cost)
}
...
inline const ::acu::planning::StBoundaryConfig& PolyStSpeedConfig::st_boundary_config() const {
  const ::acu::planning::StBoundaryConfig* p = st_boundary_config_;
  // @@protoc_insertion_point(field_get:acu.planning.PolyStSpeedConfig.st_boundary_config)
  return p != NULL ? *p : *reinterpret_cast<const ::acu::planning::StBoundaryConfig*>(
      &::acu::planning::_StBoundaryConfig_default_instance_);
}
inline ::acu::planning::StBoundaryConfig* PolyStSpeedConfig::release_st_boundary_config() {
  // @@protoc_insertion_point(field_release:acu.planning.PolyStSpeedConfig.st_boundary_config)
  clear_has_st_boundary_config();
  ::acu::planning::StBoundaryConfig* temp = st_boundary_config_;
  st_boundary_config_ = NULL;
  return temp;
}
inline ::acu::planning::StBoundaryConfig* PolyStSpeedConfig::mutable_st_boundary_config() {
  set_has_st_boundary_config();
  if (st_boundary_config_ == NULL) {
    st_boundary_config_ = new ::acu::planning::StBoundaryConfig;
  }
  // @@protoc_insertion_point(field_mutable:acu.planning.PolyStSpeedConfig.st_boundary_config)
  return st_boundary_config_;
}
inline void PolyStSpeedConfig::set_allocated_st_boundary_config(::acu::planning::StBoundaryConfig* st_boundary_config) {
  ...
  // @@protoc_insertion_point(field_set_allocated:acu.planning.PolyStSpeedConfig.st_boundary_config)
}
...
#endif  // PROTOBUF_poly_5fst_5fspeed_5fconfig_2eproto__INCLUDED
