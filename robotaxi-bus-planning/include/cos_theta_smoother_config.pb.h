...
#ifndef PROTOBUF_cos_5ftheta_5fsmoother_5fconfig_2eproto__INCLUDED
#define PROTOBUF_cos_5ftheta_5fsmoother_5fconfig_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsCosThetaSmootherConfig();
}
}  // namespace protobuf_cos_5ftheta_5fsmoother_5fconfig_2eproto
namespace acu {
namespace planning {
...
class CosThetaSmootherConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.CosThetaSmootherConfig) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:acu.planning.CosThetaSmootherConfig)
 private:
  ...
  friend void ::protobuf_cos_5ftheta_5fsmoother_5fconfig_2eproto::InitDefaultsCosThetaSmootherConfigImpl();
};
// ===================================================================
...
inline double CosThetaSmootherConfig::weight_cos_included_angle() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.weight_cos_included_angle)
...
inline void CosThetaSmootherConfig::set_weight_cos_included_angle(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.weight_cos_included_angle)
}
...
inline double CosThetaSmootherConfig::weight_anchor_points() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.weight_anchor_points)
...
inline void CosThetaSmootherConfig::set_weight_anchor_points(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.weight_anchor_points)
}
...
inline double CosThetaSmootherConfig::weight_length() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.weight_length)
...
inline void CosThetaSmootherConfig::set_weight_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.weight_length)
}
...
inline ::google::protobuf::int32 CosThetaSmootherConfig::print_level() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.print_level)
  return print_level_;
}
inline void CosThetaSmootherConfig::set_print_level(::google::protobuf::int32 value) {
  set_has_print_level();
  print_level_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.print_level)
}
...
inline ::google::protobuf::int32 CosThetaSmootherConfig::max_num_of_iterations() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.max_num_of_iterations)
...
inline void CosThetaSmootherConfig::set_max_num_of_iterations(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.max_num_of_iterations)
}
...
inline ::google::protobuf::int32 CosThetaSmootherConfig::acceptable_num_of_iterations() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.acceptable_num_of_iterations)
...
inline void CosThetaSmootherConfig::set_acceptable_num_of_iterations(::google::protobuf::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.acceptable_num_of_iterations)
}
...
inline double CosThetaSmootherConfig::tol() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.tol)
  return tol_;
}
inline void CosThetaSmootherConfig::set_tol(double value) {
  set_has_tol();
  tol_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.tol)
}
...
inline double CosThetaSmootherConfig::acceptable_tol() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.acceptable_tol)
...
inline void CosThetaSmootherConfig::set_acceptable_tol(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.acceptable_tol)
}
...
inline bool CosThetaSmootherConfig::ipopt_use_automatic_differentiation() const {
  // @@protoc_insertion_point(field_get:acu.planning.CosThetaSmootherConfig.ipopt_use_automatic_differentiation)
...
inline void CosThetaSmootherConfig::set_ipopt_use_automatic_differentiation(bool value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.CosThetaSmootherConfig.ipopt_use_automatic_differentiation)
}
...
#endif  // PROTOBUF_cos_5ftheta_5fsmoother_5fconfig_2eproto__INCLUDED
