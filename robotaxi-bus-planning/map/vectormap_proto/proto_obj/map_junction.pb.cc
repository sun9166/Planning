...
void InitDefaultsJunctionImpl() {
  ...
  {
    void* ptr = &::acu::hdmap::_Junction_default_instance_;
    new (ptr) ::acu::hdmap::Junction();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::acu::hdmap::Junction::InitAsDefaultInstance();
}

void InitDefaultsJunction() {
  static GOOGLE_PROTOBUF_DECLARE_ONCE(once);
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsJunctionImpl);
}

::google::protobuf::Metadata file_level_metadata[1];

const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::acu::hdmap::Junction, _has_bits_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::acu::hdmap::Junction, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::acu::hdmap::Junction, id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::acu::hdmap::Junction, polygon_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::acu::hdmap::Junction, overlap_id_),
  0,
  1,
  ~0u,
};
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::acu::hdmap::Junction)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&::acu::hdmap::_Junction_default_instance_),
};
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "map_junction.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      "\n\022map_junction.proto\022\tacu.hdmap\032\014map_id."
      "proto\032\022map_geometry.proto\"m\n\010Junction\022\031\n"
      "\002id\030\001 \001(\0132\r.acu.hdmap.Id\022#\n\007polygon\030\002 \001("
      "\0132\022.acu.hdmap.Polygon\022!\n\noverlap_id\030\003 \003("
      "\0132\r.acu.hdmap.Id"
  };
...
void Junction::InitAsDefaultInstance() {
  ::acu::hdmap::_Junction_default_instance_._instance.get_mutable()->id_ = const_cast< ::acu::hdmap::Id*>(
      ::acu::hdmap::Id::internal_default_instance());
  ::acu::hdmap::_Junction_default_instance_._instance.get_mutable()->polygon_ = const_cast< ::acu::hdmap::Polygon*>(
...
Junction::Junction()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:acu.hdmap.Junction)
}
Junction::Junction(const Junction& from)
  ...
  // @@protoc_insertion_point(copy_constructor:acu.hdmap.Junction)
}
...
Junction::~Junction() {
  // @@protoc_insertion_point(destructor:acu.hdmap.Junction)
  SharedDtor();
}
...
void Junction::Clear() {
// @@protoc_insertion_point(message_clear_start:acu.hdmap.Junction)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:acu.hdmap.Junction)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:acu.hdmap.Junction)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:acu.hdmap.Junction)
  return false;
#undef DO_
}
...
void Junction::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:acu.hdmap.Junction)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:acu.hdmap.Junction)
}

::google::protobuf::uint8* Junction::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  // @@protoc_insertion_point(serialize_to_array_start:acu.hdmap.Junction)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:acu.hdmap.Junction)
  return target;
}

size_t Junction::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:acu.hdmap.Junction)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:acu.hdmap.Junction)
  GOOGLE_DCHECK_NE(&from, this);
  const Junction* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const Junction>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:acu.hdmap.Junction)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:acu.hdmap.Junction)
    MergeFrom(*source);
  }
}

void Junction::MergeFrom(const Junction& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:acu.hdmap.Junction)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:acu.hdmap.Junction)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:acu.hdmap.Junction)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
