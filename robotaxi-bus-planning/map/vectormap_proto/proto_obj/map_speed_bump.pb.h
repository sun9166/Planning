...
#ifndef PROTOBUF_map_5fspeed_5fbump_2eproto__INCLUDED
#define PROTOBUF_map_5fspeed_5fbump_2eproto__INCLUDED
...
class SpeedBump : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.hdmap.SpeedBump) */ {
 public:
  SpeedBump();
  virtual ~SpeedBump();
  ...
  // @@protoc_insertion_point(class_scope:acu.hdmap.SpeedBump)
 private:
  void set_has_id();
  void clear_has_id();
  ...
  friend void ::protobuf_map_5fspeed_5fbump_2eproto::InitDefaultsSpeedBumpImpl();
};
// ===================================================================
...
inline const ::acu::hdmap::Id& SpeedBump::id() const {
  const ::acu::hdmap::Id* p = id_;
  // @@protoc_insertion_point(field_get:acu.hdmap.SpeedBump.id)
  return p != NULL ? *p : *reinterpret_cast<const ::acu::hdmap::Id*>(
      &::acu::hdmap::_Id_default_instance_);
}
inline ::acu::hdmap::Id* SpeedBump::release_id() {
  // @@protoc_insertion_point(field_release:acu.hdmap.SpeedBump.id)
  clear_has_id();
  ::acu::hdmap::Id* temp = id_;
  id_ = NULL;
  return temp;
}
inline ::acu::hdmap::Id* SpeedBump::mutable_id() {
  set_has_id();
  if (id_ == NULL) {
    id_ = new ::acu::hdmap::Id;
  }
  // @@protoc_insertion_point(field_mutable:acu.hdmap.SpeedBump.id)
  return id_;
}
inline void SpeedBump::set_allocated_id(::acu::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:acu.hdmap.SpeedBump.id)
}
...
inline const ::acu::hdmap::Polygon& SpeedBump::polygon() const {
  const ::acu::hdmap::Polygon* p = polygon_;
  // @@protoc_insertion_point(field_get:acu.hdmap.SpeedBump.polygon)
  return p != NULL ? *p : *reinterpret_cast<const ::acu::hdmap::Polygon*>(
      &::acu::hdmap::_Polygon_default_instance_);
}
inline ::acu::hdmap::Polygon* SpeedBump::release_polygon() {
  // @@protoc_insertion_point(field_release:acu.hdmap.SpeedBump.polygon)
  clear_has_polygon();
  ::acu::hdmap::Polygon* temp = polygon_;
  polygon_ = NULL;
  return temp;
}
inline ::acu::hdmap::Polygon* SpeedBump::mutable_polygon() {
  set_has_polygon();
  if (polygon_ == NULL) {
    polygon_ = new ::acu::hdmap::Polygon;
  }
  // @@protoc_insertion_point(field_mutable:acu.hdmap.SpeedBump.polygon)
  return polygon_;
}
inline void SpeedBump::set_allocated_polygon(::acu::hdmap::Polygon* polygon) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  polygon_ = polygon;
  // @@protoc_insertion_point(field_set_allocated:acu.hdmap.SpeedBump.polygon)
}
...
inline const ::acu::hdmap::Id& SpeedBump::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:acu.hdmap.SpeedBump.overlap_id)
  return overlap_id_.Get(index);
}
inline ::acu::hdmap::Id* SpeedBump::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:acu.hdmap.SpeedBump.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::acu::hdmap::Id* SpeedBump::add_overlap_id() {
  // @@protoc_insertion_point(field_add:acu.hdmap.SpeedBump.overlap_id)
  return overlap_id_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::acu::hdmap::Id >*
SpeedBump::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:acu.hdmap.SpeedBump.overlap_id)
  return &overlap_id_;
}
inline const ::google::protobuf::RepeatedPtrField< ::acu::hdmap::Id >&
SpeedBump::overlap_id() const {
  // @@protoc_insertion_point(field_list:acu.hdmap.SpeedBump.overlap_id)
  return overlap_id_;
}
...
#endif  // PROTOBUF_map_5fspeed_5fbump_2eproto__INCLUDED
