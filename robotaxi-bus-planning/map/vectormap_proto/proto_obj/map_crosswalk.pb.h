...
#ifndef PROTOBUF_map_5fcrosswalk_2eproto__INCLUDED
#define PROTOBUF_map_5fcrosswalk_2eproto__INCLUDED
...
class Crosswalk : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.hdmap.Crosswalk) */ {
 public:
  Crosswalk();
  virtual ~Crosswalk();
  ...
  // @@protoc_insertion_point(class_scope:acu.hdmap.Crosswalk)
 private:
  void set_has_id();
  void clear_has_id();
  ...
  friend struct ::protobuf_map_5fcrosswalk_2eproto::TableStruct;
  friend void ::protobuf_map_5fcrosswalk_2eproto::InitDefaultsCrosswalkImpl();
};
// ===================================================================
...
inline const ::acu::hdmap::Id& Crosswalk::id() const {
  const ::acu::hdmap::Id* p = id_;
  // @@protoc_insertion_point(field_get:acu.hdmap.Crosswalk.id)
  return p != NULL ? *p : *reinterpret_cast<const ::acu::hdmap::Id*>(
      &::acu::hdmap::_Id_default_instance_);
}
inline ::acu::hdmap::Id* Crosswalk::release_id() {
  // @@protoc_insertion_point(field_release:acu.hdmap.Crosswalk.id)
  clear_has_id();
  ::acu::hdmap::Id* temp = id_;
  id_ = NULL;
  return temp;
}
inline ::acu::hdmap::Id* Crosswalk::mutable_id() {
  set_has_id();
  if (id_ == NULL) {
    id_ = new ::acu::hdmap::Id;
  }
  // @@protoc_insertion_point(field_mutable:acu.hdmap.Crosswalk.id)
  return id_;
}
inline void Crosswalk::set_allocated_id(::acu::hdmap::Id* id) {
  ...
  id_ = id;
  // @@protoc_insertion_point(field_set_allocated:acu.hdmap.Crosswalk.id)
}
...
inline const ::acu::hdmap::Polygon& Crosswalk::polygon() const {
  const ::acu::hdmap::Polygon* p = polygon_;
  // @@protoc_insertion_point(field_get:acu.hdmap.Crosswalk.polygon)
  return p != NULL ? *p : *reinterpret_cast<const ::acu::hdmap::Polygon*>(
      &::acu::hdmap::_Polygon_default_instance_);
}
inline ::acu::hdmap::Polygon* Crosswalk::release_polygon() {
  // @@protoc_insertion_point(field_release:acu.hdmap.Crosswalk.polygon)
  clear_has_polygon();
  ::acu::hdmap::Polygon* temp = polygon_;
  polygon_ = NULL;
  return temp;
}
inline ::acu::hdmap::Polygon* Crosswalk::mutable_polygon() {
  set_has_polygon();
  if (polygon_ == NULL) {
    polygon_ = new ::acu::hdmap::Polygon;
  }
  // @@protoc_insertion_point(field_mutable:acu.hdmap.Crosswalk.polygon)
  return polygon_;
}
inline void Crosswalk::set_allocated_polygon(::acu::hdmap::Polygon* polygon) {
  ::google::protobuf::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == NULL) {
  ...
  polygon_ = polygon;
  // @@protoc_insertion_point(field_set_allocated:acu.hdmap.Crosswalk.polygon)
}
...
inline const ::acu::hdmap::Id& Crosswalk::overlap_id(int index) const {
  // @@protoc_insertion_point(field_get:acu.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Get(index);
}
inline ::acu::hdmap::Id* Crosswalk::mutable_overlap_id(int index) {
  // @@protoc_insertion_point(field_mutable:acu.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Mutable(index);
}
inline ::acu::hdmap::Id* Crosswalk::add_overlap_id() {
  // @@protoc_insertion_point(field_add:acu.hdmap.Crosswalk.overlap_id)
  return overlap_id_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::acu::hdmap::Id >*
Crosswalk::mutable_overlap_id() {
  // @@protoc_insertion_point(field_mutable_list:acu.hdmap.Crosswalk.overlap_id)
  return &overlap_id_;
}
inline const ::google::protobuf::RepeatedPtrField< ::acu::hdmap::Id >&
Crosswalk::overlap_id() const {
  // @@protoc_insertion_point(field_list:acu.hdmap.Crosswalk.overlap_id)
  return overlap_id_;
}
...
#endif  // PROTOBUF_map_5fcrosswalk_2eproto__INCLUDED
