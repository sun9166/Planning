...
#ifndef PROTOBUF_map_5fid_2eproto__INCLUDED
#define PROTOBUF_map_5fid_2eproto__INCLUDED
...
class Id : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.hdmap.Id) */ {
 public:
  Id();
  virtual ~Id();
  ...
  // @@protoc_insertion_point(class_scope:acu.hdmap.Id)
 private:
  void set_has_id();
  void clear_has_id();
  ...
  friend void ::protobuf_map_5fid_2eproto::InitDefaultsIdImpl();
};
// ===================================================================
...
inline const ::std::string& Id::id() const {
  // @@protoc_insertion_point(field_get:acu.hdmap.Id.id)
  return id_.GetNoArena();
}
inline void Id::set_id(const ::std::string& value) {
  set_has_id();
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:acu.hdmap.Id.id)
}
#if LANG_CXX11
inline void Id::set_id(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:acu.hdmap.Id.id)
}
#endif
inline void Id::set_id(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:acu.hdmap.Id.id)
}
inline void Id::set_id(const char* value, size_t size) {
  set_has_id();
  id_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:acu.hdmap.Id.id)
}
inline ::std::string* Id::mutable_id() {
  set_has_id();
  // @@protoc_insertion_point(field_mutable:acu.hdmap.Id.id)
  return id_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Id::release_id() {
  // @@protoc_insertion_point(field_release:acu.hdmap.Id.id)
  clear_has_id();
...
inline void Id::set_allocated_id(::std::string* id) {
  ...
  // @@protoc_insertion_point(field_set_allocated:acu.hdmap.Id.id)
}
...
#endif  // PROTOBUF_map_5fid_2eproto__INCLUDED
