...
int HDMap::LoadMapFromFile(const std::string& map_filename) {
   std::cout<<"Loading HDMap: " << map_filename << " ..."<<std::endl;
  return impl_.LoadMapFromFile(map_filename);
}

int HDMap::LoadMapFromProto(const Map& map_proto) {
  std::cout<<"Loading HDMap with header: "
         << map_proto.header().ShortDebugString()<<std::endl;
...
int HDMap::GetLanes(const acu::common::PointENU& point, double distance,
                    std::vector<LaneInfoConstPtr>* lanes) const {
  return impl_.GetLanes(point, distance, lanes);
}

int HDMap::GetJunctions(const acu::common::PointENU& point, double distance,
                        std::vector<JunctionInfoConstPtr>* junctions) const {
  return impl_.GetJunctions(point, distance, junctions);
}

int HDMap::GetSignals(const acu::common::PointENU& point, double distance,
                      std::vector<SignalInfoConstPtr>* signals) const {
  return impl_.GetSignals(point, distance, signals);
}

int HDMap::GetCrosswalks(const acu::common::PointENU& point, double distance,
                         std::vector<CrosswalkInfoConstPtr>* crosswalks) const {
  return impl_.GetCrosswalks(point, distance, crosswalks);
}

int HDMap::GetStopSigns(const acu::common::PointENU& point, double distance,
...
int HDMap::GetRoads(const acu::common::PointENU& point, double distance,
...
int HDMap::GetNearestLaneWithHeading(const acu::common::PointENU& point,
...
int HDMap::GetRoadBoundaries(
    const acu::common::PointENU& point, double radius,
