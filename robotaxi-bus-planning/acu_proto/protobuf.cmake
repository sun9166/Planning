...
#if(EXISTS /work/share/avos3_0/protobuf-3.5.1/src/.libs/protoc)
#   set(protoc_path "/work/share/avos3_0/protobuf-3.5.1/src/.libs/protoc ")
...
file(APPEND ${CMAKE_SOURCE_DIR}/build/${PROJECT_NAME}/generate_proto_so.sh "${PROTO_COMPILE_ACU} ${CMAKE_SOURCE_DIR}/build/proto_tmp/*.cc ${PKG_INFO_ACU} -I${CMAKE_SOURCE_DIR}/build/proto_tmp/ --std=c++11 -fPIC -shared -o ${CMAKE_SOURCE_DIR}/build/proto_tmp/lib/lib${PROJECT_NAME}.so")
