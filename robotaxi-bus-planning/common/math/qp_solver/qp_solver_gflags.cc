...
double FLAGS_default_active_set_eps_num = -1e-7;
double FLAGS_default_active_set_eps_den = 1e-7;
double FLAGS_default_active_set_eps_iter_ref = 1e-7;
bool FLAGS_default_enable_active_set_debug_info = false;
