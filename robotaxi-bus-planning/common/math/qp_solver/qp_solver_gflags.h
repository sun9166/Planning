...
extern double FLAGS_default_active_set_eps_num;
extern double FLAGS_default_active_set_eps_den;
extern double FLAGS_default_active_set_eps_iter_ref;
extern bool FLAGS_default_enable_active_set_debug_info;
