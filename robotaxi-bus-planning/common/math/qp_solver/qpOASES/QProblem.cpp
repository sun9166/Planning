								...
								)
{
	...
	if ( ( guessedBounds != 0 ) || ( guessedConstraints != 0 ) )
	{
		if ( cputime != 0 ) {
			...
			// std::cout<<"1)start time = "<<starttime<<std::endl;
		}
		...
		if ( cputime != 0 )
		{
			...
			// std::cout<<"2)auxTime "<<auxTime<<", start time = "<<starttime<<std::endl;
			*cputime -= auxTime;
		}
	}
										...
										)
{
	...
	if ( cputime != 0 ) {
		starttime = getCPUtime( );
		// std::cout<<"3)start time = "<<starttime<<std::endl;
	}
	...
	if ( cputime != 0 ) {
		*cputime -= getCPUtime( ) - starttime;
		// std::cout<<"4)*cputime = "<<*cputime<<std::endl;
	}
	...
	if ( cputime != 0 ) {
		*cputime = getCPUtime( ) - starttime;
		// std::cout<<"5)*cputime  = "<<*cputime <<std::endl;
	}
								...
								)
{
	...
	if ( cputime != 0 ) {
		starttime = getCPUtime( );
		// std::cout<<"6)start time = "<<starttime<<std::endl;
	}
...
*/
	...
	for( iter=nWSRperformed; iter<nWSR; ++iter )
	{
		...
		if ( returnvalue != SUCCESSFUL_RETURN )
		{
			...
			if ( cputime != 0 ) {
				*cputime = getCPUtime( ) - starttime;
				// std::cout<<"7)*cputime = "<<*cputime<<std::endl;
			}
		...
		if ( returnvalue != SUCCESSFUL_RETURN )
		{
			...
			if ( cputime != 0 ) {
				*cputime = getCPUtime( ) - starttime;
				// std::cout<<"8)*cputime = "<<*cputime<<std::endl;
			}
		...
		if ( returnvalue != SUCCESSFUL_RETURN )
		{
			...
			if ( cputime != 0 ) {
				*cputime = getCPUtime( ) - starttime;
				// std::cout<<"9)*cputime = "<<*cputime<<std::endl;
			}
		...
		if ( homotopyLength <= options.terminationTolerance )
		{
			...
			if ( cputime != 0 ) {
				*cputime = getCPUtime( ) - starttime;
				// std::cout<<"10)*cputime = "<<*cputime<<std::endl;
			}
		...
		if ( returnvalue != SUCCESSFUL_RETURN )
		{
			...
			if ( cputime != 0 ) {
				*cputime = getCPUtime( ) - starttime;
				// std::cout<<"11)*cputime = "<<*cputime<<std::endl;
			}
	...
	if ( cputime != 0 ) {
		*cputime = getCPUtime( ) - starttime;
		// std::cout<<"12)*cputime = "<<*cputime<<std::endl;
	}
