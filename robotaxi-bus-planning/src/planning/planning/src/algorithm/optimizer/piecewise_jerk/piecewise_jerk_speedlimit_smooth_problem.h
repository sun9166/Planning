...
class PiecewiseJerkSpeedLimitSmoothProblem : public PiecewiseJerkProblem {
 public:
  PiecewiseJerkSpeedLimitSmoothProblem(const size_t num_of_knots, const double delta_s,
                           const std::array<double, 3>& x_init);

  virtual ~PiecewiseJerkSpeedLimitSmoothProblem() = default;
