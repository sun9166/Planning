...
/**
 * @class SpeedPlanner
 * @brief SpeedPlanner is an expectation maximization planner.
 */
...
class SpeedPlanner : public Planner {
 ...
 private:
  void RegisterTasks();
  void GetDRTrajectory(DiscretizedTrajectory* ptr_discretized_trajectory,
