...
#ifndef COMMON_TOOLBOX_GEOMETRY_INCLUDE_CURVES_DUBIONS_H__
#define COMMON_TOOLBOX_GEOMETRY_INCLUDE_CURVES_DUBIONS_H__
...
class Dubins {
 ...
 public:
  void GetPath(SiteVec& list, Site start, Site end, double radius = 1.4,
               double density = 0.10);
};
}  // geometry
#endif /* __TOOLBOX_GEOMETRY_CURVES_DUBIONS_H__ */
