...
#ifndef PROTOBUF_sl_5fboundary_2eproto__INCLUDED
#define PROTOBUF_sl_5fboundary_2eproto__INCLUDED
...
class SLBoundary : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.SLBoundary) */ {
 public:
  SLBoundary();
  virtual ~SLBoundary();
  ...
  // @@protoc_insertion_point(class_scope:acu.planning.SLBoundary)
 private:
  ...
  double start_l_;
  double end_l_;
  friend struct ::protobuf_sl_5fboundary_2eproto::TableStruct;
  friend void ::protobuf_sl_5fboundary_2eproto::InitDefaultsSLBoundaryImpl();
};
// ===================================================================
...
inline double SLBoundary::start_s() const {
  // @@protoc_insertion_point(field_get:acu.planning.SLBoundary.start_s)
  return start_s_;
}
inline void SLBoundary::set_start_s(double value) {
  set_has_start_s();
  start_s_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.SLBoundary.start_s)
}
...
inline double SLBoundary::end_s() const {
  // @@protoc_insertion_point(field_get:acu.planning.SLBoundary.end_s)
  return end_s_;
}
inline void SLBoundary::set_end_s(double value) {
  set_has_end_s();
  end_s_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.SLBoundary.end_s)
}
...
inline double SLBoundary::start_l() const {
  // @@protoc_insertion_point(field_get:acu.planning.SLBoundary.start_l)
  return start_l_;
}
inline void SLBoundary::set_start_l(double value) {
  set_has_start_l();
  start_l_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.SLBoundary.start_l)
}
...
inline double SLBoundary::end_l() const {
  // @@protoc_insertion_point(field_get:acu.planning.SLBoundary.end_l)
  return end_l_;
}
inline void SLBoundary::set_end_l(double value) {
  set_has_end_l();
  end_l_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.SLBoundary.end_l)
}
...
#endif  // PROTOBUF_sl_5fboundary_2eproto__INCLUDED
