...
#ifndef PROTOBUF_reference_5fline_5fsmoother_5fconfig_2eproto__INCLUDED
#define PROTOBUF_reference_5fline_5fsmoother_5fconfig_2eproto__INCLUDED
...
inline void InitDefaults() {
  InitDefaultsQpSplineSmootherConfig();
  InitDefaultsSpiralSmootherConfig();
  InitDefaultsDiscretePointsSmootherConfig();
  InitDefaultsReferenceLineSmootherConfig();
}
}  // namespace protobuf_reference_5fline_5fsmoother_5fconfig_2eproto
namespace acu {
namespace planning {
...
class QpSplineSmootherConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.QpSplineSmootherConfig) */ {
 public:
  ...
  inline QpSplineSmootherConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  QpSplineSmootherConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:acu.planning.QpSplineSmootherConfig)
 private:
  ...
  friend void ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::InitDefaultsQpSplineSmootherConfigImpl();
};
// -------------------------------------------------------------------

class SpiralSmootherConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.SpiralSmootherConfig) */ {
 public:
  ...
  inline SpiralSmootherConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  SpiralSmootherConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  // @@protoc_insertion_point(class_scope:acu.planning.SpiralSmootherConfig)
 private:
  ...
  friend struct ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::TableStruct;
  friend void ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::InitDefaultsSpiralSmootherConfigImpl();
};
// -------------------------------------------------------------------

class DiscretePointsSmootherConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.DiscretePointsSmootherConfig) */ {
 public:
  ...
  inline DiscretePointsSmootherConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  DiscretePointsSmootherConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  ::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod smoothing_method() const;
  void set_smoothing_method(::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod value);
  ...
  const ::acu::planning::CosThetaSmootherConfig& cos_theta_smoothing() const;
  ::acu::planning::CosThetaSmootherConfig* release_cos_theta_smoothing();
  ::acu::planning::CosThetaSmootherConfig* mutable_cos_theta_smoothing();
  void set_allocated_cos_theta_smoothing(::acu::planning::CosThetaSmootherConfig* cos_theta_smoothing);
  ...
  const ::acu::planning::FemPosDeviationSmootherConfig& fem_pos_deviation_smoothing() const;
  ::acu::planning::FemPosDeviationSmootherConfig* release_fem_pos_deviation_smoothing();
  ::acu::planning::FemPosDeviationSmootherConfig* mutable_fem_pos_deviation_smoothing();
  void set_allocated_fem_pos_deviation_smoothing(::acu::planning::FemPosDeviationSmootherConfig* fem_pos_deviation_smoothing);

  SmootherConfigCase SmootherConfig_case() const;
  // @@protoc_insertion_point(class_scope:acu.planning.DiscretePointsSmootherConfig)
 private:
  ...
  union SmootherConfigUnion {
    SmootherConfigUnion() {}
    ::acu::planning::CosThetaSmootherConfig* cos_theta_smoothing_;
    ::acu::planning::FemPosDeviationSmootherConfig* fem_pos_deviation_smoothing_;
  } SmootherConfig_;
  ::google::protobuf::uint32 _oneof_case_[1];

  friend struct ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::TableStruct;
  friend void ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::InitDefaultsDiscretePointsSmootherConfigImpl();
};
// -------------------------------------------------------------------

class ReferenceLineSmootherConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:acu.planning.ReferenceLineSmootherConfig) */ {
 public:
  ...
  inline ReferenceLineSmootherConfig* New() const PROTOBUF_FINAL { return New(NULL); }

  ReferenceLineSmootherConfig* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  const ::acu::planning::QpSplineSmootherConfig& qp_spline() const;
  ::acu::planning::QpSplineSmootherConfig* release_qp_spline();
  ::acu::planning::QpSplineSmootherConfig* mutable_qp_spline();
  void set_allocated_qp_spline(::acu::planning::QpSplineSmootherConfig* qp_spline);

  // optional .acu.planning.SpiralSmootherConfig spiral = 21;
  bool has_spiral() const;
  void clear_spiral();
  static const int kSpiralFieldNumber = 21;
  const ::acu::planning::SpiralSmootherConfig& spiral() const;
  ::acu::planning::SpiralSmootherConfig* release_spiral();
  ::acu::planning::SpiralSmootherConfig* mutable_spiral();
  void set_allocated_spiral(::acu::planning::SpiralSmootherConfig* spiral);
  ...
  const ::acu::planning::DiscretePointsSmootherConfig& discrete_points() const;
  ::acu::planning::DiscretePointsSmootherConfig* release_discrete_points();
  ::acu::planning::DiscretePointsSmootherConfig* mutable_discrete_points();
  void set_allocated_discrete_points(::acu::planning::DiscretePointsSmootherConfig* discrete_points);

  SmootherConfigCase SmootherConfig_case() const;
  // @@protoc_insertion_point(class_scope:acu.planning.ReferenceLineSmootherConfig)
 private:
  ...
  union SmootherConfigUnion {
    SmootherConfigUnion() {}
    ::acu::planning::QpSplineSmootherConfig* qp_spline_;
    ::acu::planning::SpiralSmootherConfig* spiral_;
    ::acu::planning::DiscretePointsSmootherConfig* discrete_points_;
  } SmootherConfig_;
  ::google::protobuf::uint32 _oneof_case_[1];

  friend struct ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::TableStruct;
  friend void ::protobuf_reference_5fline_5fsmoother_5fconfig_2eproto::InitDefaultsReferenceLineSmootherConfigImpl();
};
// ===================================================================
...
inline ::google::protobuf::uint32 QpSplineSmootherConfig::spline_order() const {
  // @@protoc_insertion_point(field_get:acu.planning.QpSplineSmootherConfig.spline_order)
  return spline_order_;
}
inline void QpSplineSmootherConfig::set_spline_order(::google::protobuf::uint32 value) {
  set_has_spline_order();
  spline_order_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.QpSplineSmootherConfig.spline_order)
}
...
inline double QpSplineSmootherConfig::max_spline_length() const {
  // @@protoc_insertion_point(field_get:acu.planning.QpSplineSmootherConfig.max_spline_length)
...
inline void QpSplineSmootherConfig::set_max_spline_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.QpSplineSmootherConfig.max_spline_length)
}
...
inline double QpSplineSmootherConfig::regularization_weight() const {
  // @@protoc_insertion_point(field_get:acu.planning.QpSplineSmootherConfig.regularization_weight)
...
inline void QpSplineSmootherConfig::set_regularization_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.QpSplineSmootherConfig.regularization_weight)
}
...
inline double QpSplineSmootherConfig::second_derivative_weight() const {
  // @@protoc_insertion_point(field_get:acu.planning.QpSplineSmootherConfig.second_derivative_weight)
...
inline void QpSplineSmootherConfig::set_second_derivative_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.QpSplineSmootherConfig.second_derivative_weight)
}
...
inline double QpSplineSmootherConfig::third_derivative_weight() const {
  // @@protoc_insertion_point(field_get:acu.planning.QpSplineSmootherConfig.third_derivative_weight)
...
inline void QpSplineSmootherConfig::set_third_derivative_weight(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.QpSplineSmootherConfig.third_derivative_weight)
}
...
inline double SpiralSmootherConfig::max_deviation() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.max_deviation)
...
inline void SpiralSmootherConfig::set_max_deviation(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.max_deviation)
}
...
inline double SpiralSmootherConfig::piecewise_length() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.piecewise_length)
...
inline void SpiralSmootherConfig::set_piecewise_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.piecewise_length)
}
...
inline ::google::protobuf::uint32 SpiralSmootherConfig::max_iteration() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.max_iteration)
...
inline void SpiralSmootherConfig::set_max_iteration(::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.max_iteration)
}
...
inline double SpiralSmootherConfig::opt_tol() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.opt_tol)
  return opt_tol_;
}
inline void SpiralSmootherConfig::set_opt_tol(double value) {
  set_has_opt_tol();
  opt_tol_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.opt_tol)
}
...
inline double SpiralSmootherConfig::opt_acceptable_tol() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.opt_acceptable_tol)
...
inline void SpiralSmootherConfig::set_opt_acceptable_tol(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.opt_acceptable_tol)
}
...
inline ::google::protobuf::uint32 SpiralSmootherConfig::opt_acceptable_iteration() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.opt_acceptable_iteration)
...
inline void SpiralSmootherConfig::set_opt_acceptable_iteration(::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.opt_acceptable_iteration)
}
...
inline double SpiralSmootherConfig::weight_curve_length() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.weight_curve_length)
...
inline void SpiralSmootherConfig::set_weight_curve_length(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.weight_curve_length)
}
...
inline double SpiralSmootherConfig::weight_kappa() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.weight_kappa)
  return weight_kappa_;
}
inline void SpiralSmootherConfig::set_weight_kappa(double value) {
  set_has_weight_kappa();
  weight_kappa_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.weight_kappa)
}
...
inline double SpiralSmootherConfig::weight_dkappa() const {
  // @@protoc_insertion_point(field_get:acu.planning.SpiralSmootherConfig.weight_dkappa)
...
inline void SpiralSmootherConfig::set_weight_dkappa(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.SpiralSmootherConfig.weight_dkappa)
}
...
inline ::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod DiscretePointsSmootherConfig::smoothing_method() const {
  // @@protoc_insertion_point(field_get:acu.planning.DiscretePointsSmootherConfig.smoothing_method)
  return static_cast< ::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod >(smoothing_method_);
}
inline void DiscretePointsSmootherConfig::set_smoothing_method(::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod value) {
  assert(::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod_IsValid(value));
  set_has_smoothing_method();
  smoothing_method_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.DiscretePointsSmootherConfig.smoothing_method)
}
...
inline ::acu::planning::CosThetaSmootherConfig* DiscretePointsSmootherConfig::release_cos_theta_smoothing() {
  // @@protoc_insertion_point(field_release:acu.planning.DiscretePointsSmootherConfig.cos_theta_smoothing)
  if (has_cos_theta_smoothing()) {
    clear_has_SmootherConfig();
      ::acu::planning::CosThetaSmootherConfig* temp = SmootherConfig_.cos_theta_smoothing_;
...
inline const ::acu::planning::CosThetaSmootherConfig& DiscretePointsSmootherConfig::cos_theta_smoothing() const {
  // @@protoc_insertion_point(field_get:acu.planning.DiscretePointsSmootherConfig.cos_theta_smoothing)
  return has_cos_theta_smoothing()
      ? *SmootherConfig_.cos_theta_smoothing_
      : *reinterpret_cast< ::acu::planning::CosThetaSmootherConfig*>(&::acu::planning::_CosThetaSmootherConfig_default_instance_);
}
inline ::acu::planning::CosThetaSmootherConfig* DiscretePointsSmootherConfig::mutable_cos_theta_smoothing() {
  if (!has_cos_theta_smoothing()) {
    clear_SmootherConfig();
    set_has_cos_theta_smoothing();
    SmootherConfig_.cos_theta_smoothing_ = new ::acu::planning::CosThetaSmootherConfig;
  }
  // @@protoc_insertion_point(field_mutable:acu.planning.DiscretePointsSmootherConfig.cos_theta_smoothing)
...
inline ::acu::planning::FemPosDeviationSmootherConfig* DiscretePointsSmootherConfig::release_fem_pos_deviation_smoothing() {
  // @@protoc_insertion_point(field_release:acu.planning.DiscretePointsSmootherConfig.fem_pos_deviation_smoothing)
  if (has_fem_pos_deviation_smoothing()) {
    clear_has_SmootherConfig();
      ::acu::planning::FemPosDeviationSmootherConfig* temp = SmootherConfig_.fem_pos_deviation_smoothing_;
...
inline const ::acu::planning::FemPosDeviationSmootherConfig& DiscretePointsSmootherConfig::fem_pos_deviation_smoothing() const {
  // @@protoc_insertion_point(field_get:acu.planning.DiscretePointsSmootherConfig.fem_pos_deviation_smoothing)
  return has_fem_pos_deviation_smoothing()
      ? *SmootherConfig_.fem_pos_deviation_smoothing_
      : *reinterpret_cast< ::acu::planning::FemPosDeviationSmootherConfig*>(&::acu::planning::_FemPosDeviationSmootherConfig_default_instance_);
}
inline ::acu::planning::FemPosDeviationSmootherConfig* DiscretePointsSmootherConfig::mutable_fem_pos_deviation_smoothing() {
  if (!has_fem_pos_deviation_smoothing()) {
    clear_SmootherConfig();
    set_has_fem_pos_deviation_smoothing();
    SmootherConfig_.fem_pos_deviation_smoothing_ = new ::acu::planning::FemPosDeviationSmootherConfig;
  }
  // @@protoc_insertion_point(field_mutable:acu.planning.DiscretePointsSmootherConfig.fem_pos_deviation_smoothing)
...
inline double ReferenceLineSmootherConfig::max_constraint_interval() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.max_constraint_interval)
...
inline void ReferenceLineSmootherConfig::set_max_constraint_interval(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.max_constraint_interval)
}
...
inline double ReferenceLineSmootherConfig::longitudinal_boundary_bound() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.longitudinal_boundary_bound)
...
inline void ReferenceLineSmootherConfig::set_longitudinal_boundary_bound(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.longitudinal_boundary_bound)
}
...
inline double ReferenceLineSmootherConfig::max_lateral_boundary_bound() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.max_lateral_boundary_bound)
...
inline void ReferenceLineSmootherConfig::set_max_lateral_boundary_bound(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.max_lateral_boundary_bound)
}
...
inline double ReferenceLineSmootherConfig::min_lateral_boundary_bound() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.min_lateral_boundary_bound)
...
inline void ReferenceLineSmootherConfig::set_min_lateral_boundary_bound(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.min_lateral_boundary_bound)
}
...
inline ::google::protobuf::uint32 ReferenceLineSmootherConfig::num_of_total_points() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.num_of_total_points)
...
inline void ReferenceLineSmootherConfig::set_num_of_total_points(::google::protobuf::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.num_of_total_points)
}
...
inline double ReferenceLineSmootherConfig::curb_shift() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.curb_shift)
  return curb_shift_;
}
inline void ReferenceLineSmootherConfig::set_curb_shift(double value) {
  set_has_curb_shift();
  curb_shift_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.curb_shift)
}
...
inline double ReferenceLineSmootherConfig::lateral_buffer() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.lateral_buffer)
...
inline void ReferenceLineSmootherConfig::set_lateral_buffer(double value) {
  ...
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.lateral_buffer)
}
...
inline double ReferenceLineSmootherConfig::resolution() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.resolution)
  return resolution_;
}
inline void ReferenceLineSmootherConfig::set_resolution(double value) {
  set_has_resolution();
  resolution_ = value;
  // @@protoc_insertion_point(field_set:acu.planning.ReferenceLineSmootherConfig.resolution)
}
...
inline ::acu::planning::QpSplineSmootherConfig* ReferenceLineSmootherConfig::release_qp_spline() {
  // @@protoc_insertion_point(field_release:acu.planning.ReferenceLineSmootherConfig.qp_spline)
  if (has_qp_spline()) {
    clear_has_SmootherConfig();
      ::acu::planning::QpSplineSmootherConfig* temp = SmootherConfig_.qp_spline_;
...
inline const ::acu::planning::QpSplineSmootherConfig& ReferenceLineSmootherConfig::qp_spline() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.qp_spline)
  return has_qp_spline()
      ? *SmootherConfig_.qp_spline_
      : *reinterpret_cast< ::acu::planning::QpSplineSmootherConfig*>(&::acu::planning::_QpSplineSmootherConfig_default_instance_);
}
inline ::acu::planning::QpSplineSmootherConfig* ReferenceLineSmootherConfig::mutable_qp_spline() {
  if (!has_qp_spline()) {
    clear_SmootherConfig();
    set_has_qp_spline();
    SmootherConfig_.qp_spline_ = new ::acu::planning::QpSplineSmootherConfig;
  }
  // @@protoc_insertion_point(field_mutable:acu.planning.ReferenceLineSmootherConfig.qp_spline)
...
inline ::acu::planning::SpiralSmootherConfig* ReferenceLineSmootherConfig::release_spiral() {
  // @@protoc_insertion_point(field_release:acu.planning.ReferenceLineSmootherConfig.spiral)
  if (has_spiral()) {
    clear_has_SmootherConfig();
      ::acu::planning::SpiralSmootherConfig* temp = SmootherConfig_.spiral_;
...
inline const ::acu::planning::SpiralSmootherConfig& ReferenceLineSmootherConfig::spiral() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.spiral)
  return has_spiral()
      ? *SmootherConfig_.spiral_
      : *reinterpret_cast< ::acu::planning::SpiralSmootherConfig*>(&::acu::planning::_SpiralSmootherConfig_default_instance_);
}
inline ::acu::planning::SpiralSmootherConfig* ReferenceLineSmootherConfig::mutable_spiral() {
  if (!has_spiral()) {
    clear_SmootherConfig();
    set_has_spiral();
    SmootherConfig_.spiral_ = new ::acu::planning::SpiralSmootherConfig;
  }
  // @@protoc_insertion_point(field_mutable:acu.planning.ReferenceLineSmootherConfig.spiral)
...
inline ::acu::planning::DiscretePointsSmootherConfig* ReferenceLineSmootherConfig::release_discrete_points() {
  // @@protoc_insertion_point(field_release:acu.planning.ReferenceLineSmootherConfig.discrete_points)
  if (has_discrete_points()) {
    clear_has_SmootherConfig();
      ::acu::planning::DiscretePointsSmootherConfig* temp = SmootherConfig_.discrete_points_;
...
inline const ::acu::planning::DiscretePointsSmootherConfig& ReferenceLineSmootherConfig::discrete_points() const {
  // @@protoc_insertion_point(field_get:acu.planning.ReferenceLineSmootherConfig.discrete_points)
  return has_discrete_points()
      ? *SmootherConfig_.discrete_points_
      : *reinterpret_cast< ::acu::planning::DiscretePointsSmootherConfig*>(&::acu::planning::_DiscretePointsSmootherConfig_default_instance_);
}
inline ::acu::planning::DiscretePointsSmootherConfig* ReferenceLineSmootherConfig::mutable_discrete_points() {
  if (!has_discrete_points()) {
    clear_SmootherConfig();
    set_has_discrete_points();
    SmootherConfig_.discrete_points_ = new ::acu::planning::DiscretePointsSmootherConfig;
  }
  // @@protoc_insertion_point(field_mutable:acu.planning.ReferenceLineSmootherConfig.discrete_points)
...
template <> struct is_proto_enum< ::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod>() {
  return ::acu::planning::DiscretePointsSmootherConfig_SmoothingMethod_descriptor();
}
...
#endif  // PROTOBUF_reference_5fline_5fsmoother_5fconfig_2eproto__INCLUDED
